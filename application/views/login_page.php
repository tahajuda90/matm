        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="<?= base_url()?>">
                        <img class="align-content" src="<?= base_url()?>assets/ela/images/logo_pmo.png" alt="">
                    </a>
                </div>
                <div class="login-form">
                    ...
                    <button type="submit" value="Login" class="btn btn-success btn-flat m-b-30 m-t-30">Sign in</button>
                    <?php echo form_close();?>
                </div>
            </div>
        </div>
